		...
		<div class="accordion" id="accordion2">
		  ...
		  <div class="accordion-group">
			...
			<div id="collapseTwo" class="accordion-body collapse">
			  <div class="accordion-inner">
				<span  data-mce-mark="1">Send your official transcripts from all other colleges or programs to our Enrollment Services office (Enrollment Services, Green River Community College, 12401 SE 320th Street, Auburn, WA 98092-3622).&nbsp; </span>
			  </div>
			</div>
		  </div>
		  <div class="accordion-group">
		  ...
		  <div class="accordion-group">
			...
			<div id="collapseFour" class="accordion-body collapse">
			  <div class="accordion-inner">
				<span >Within two business days of applying online, check your email for notification of your student identification number (SID) and follow instructions for setting up your </span><a href="http://grcc.greenriver.edu/student-email/"  title="Student Email" target="_blank">Green River-issued student email account.</a>
			  </div>
			</div>
		  </div>
		  <div class="accordion-group">
			...
			<div id="collapseFive" class="accordion-body collapse">
			  <div class="accordion-inner">
				<span >Go to </span><a href="https://fafsa.ed.gov/"  target="_blank">https://fafsa.ed.gov/</a><span > and submit your FAFSA information. You should be able to add Green River to your list of schools. Our Federal School Code is 003780.&nbsp;I am also attaching the link to our </span><a href="../Documents/student-affairs/financial-aid/14-15-supplemental-financial-aid-application.pdf"  title="supplemental financial aid application" target="_blank">Green River Supplemental form</a><span ><span > that must be filled out.&nbsp; Get this filled out and turned in to the Financial Aid office as soon as possible.</span></span>
				<div class="spacer10"></div>
				<table cellpadding="5" cellspacing="3" class="deadlines" >
				<thead>
